  ...
  return (
    ...
    <div className='grid grid-cols-12 mb-16 md:gap-8'>
        <div className='col-span-12 lg:col-span-4 relative'>
           <NavLink to={`/posts/${_id}`}><img src={featured_img} height='250' width='250' alt={title} className='object-cover w-full shadow-xl hover:opacity-80 hover:scale-105 transition-all delay-200 relative h-full' onMouseEnter={handleMouseenter} onMouseLeave={handleMouseLeave} />           
           { showComment && 
                <div className='flex gap-1 items-center justify-center absolute top-1/2 left-1/2 -translate-x-2/4 -translate-y-1/2 z-10 bg-[#11111170] px-3 py-2 rounded'>                
        ...
        <div className='col-span-12 mt-5 md:mt-0 lg:col-span-8 lg:col-start-5'>
            ...
            {author.fullname ?
                ...
                <div className='flex gap-5 mb-4 items-center justify-left'>
                    <div className='text-[#4d6385]'>Created at: <FormatDate date={createdAt} /></div>
                </div>
            } 
