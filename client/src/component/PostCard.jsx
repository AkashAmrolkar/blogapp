  ...
  return (
    <div className='grid grid-cols-12 mb-16 gap-8'>
        <div className=' col-span-4'>
           <NavLink to={`/posts/${post._id}`}><img src={post.images} height='250' width='250' alt={post.title} className='object-cover w-full h-[250px] shadow-xl hover:-translate-y-4 transition-all delay-75 ease-in-out' /></NavLink> 
        </div>
        <div className=' col-span-8 col-start-5'>
            
            <NavLink to={`/posts/${post._id}`}><h1 className='font-bold text-[#302D55] text-3xl mb-4 hover:opacity-80'>{post.title}</h1></NavLink> 
